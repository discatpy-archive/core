...
class FunctionCreator:
    ...
    def __init__(
        self, name: str, *, decorators: t.Optional[list[str]] = None, is_async: bool = False
    ):
...
def parse_endpoint_func(name: str, func: dict[str, t.Any]):
...
def parse_json_file(file: dict[str, t.Any]):
    funcs: list[str] = []
